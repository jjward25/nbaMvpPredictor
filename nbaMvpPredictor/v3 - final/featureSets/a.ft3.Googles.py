...
# Rank the players by Google search mentions within each season
df['google_mentions_rank'] = df.groupby('SEASON')['google_search_mentions'].rank(ascending=False, method='dense')

# Save the updated DataFrame to a new CSV
df.to_csv('playersMvpTeamsGoogles.csv', index=False)
print(df)
df.to_clipboard()
