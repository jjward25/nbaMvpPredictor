...
filename = 'players_with_mvp_and_rankings.csv'
file_path = os.path.join(absolute_path, filename)
players_df = pd.read_csv(file_path)

# Drop non-predictive columns, like player name and ID
players_df = players_df.drop(columns=['PLAYER', 'PLAYER_ID', 'TEAM_ABBREVIATION', 'LEAGUE_ID', 'SEASON_ID', 'TEAM_ID', 'SEASON'], errors='ignore')
